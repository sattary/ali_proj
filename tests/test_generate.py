...
class TestGenerateSample:
    def test_output_shapes(self):
        ...
        I, dphi = generate_sample(x, y, r2, rng)
    ...
    def test_intensity_positive(self):
        ...
        rng = np.random.default_rng(42)
        for _ in range(10):
            I, _ = generate_sample(x, y, r2, rng)
    ...
    def test_phase_min_zero(self):
        ...
        rng = np.random.default_rng(42)
        for _ in range(10):
            _, dphi = generate_sample(x, y, r2, rng)
            assert abs(dphi.min()) < 1e-6, f"Phase min should be ~0, got {dphi.min()}"

    def test_reproducibility(self):
        x, y, r2 = _build_grid()
        I1, phi1 = generate_sample(x, y, r2, np.random.default_rng(42))
        I2, phi2 = generate_sample(x, y, r2, np.random.default_rng(42))
